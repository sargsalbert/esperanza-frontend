...
export default async function Home() {
  return (
    <>
      <div className='relative mb-17.5 flex h-[calc(100vh-84px-69px)] w-full md:mb-30 md:h-[calc(100vh-110px+39px)] lg:mb-39 lg:h-[calc(100vh-110px+75px)] 2xl:h-[calc(100vh-123px+75px)]'>
