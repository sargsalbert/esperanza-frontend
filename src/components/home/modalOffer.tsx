    ...
    >
      <div className='flex flex-col lg:flex-row lg:items-stretch'>
        ...
        <div className='flex flex-col bg-gray-100 p-[15px] pb-[30px] lg:w-1/2 lg:p-[5%]'>
          ...
          <div>
            <div className='text-center text-[14px]/[26px] sm:text-[16px]/[32px] lg:text-left'>
              <h3 className='mr-2.5 inline-flex text-[22px] font-semibold lg:mb-5 lg:flex lg:text-[30px]'>
