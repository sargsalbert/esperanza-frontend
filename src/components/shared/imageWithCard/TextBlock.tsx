...
const TextBlock = ({
  ...
  return (
    <div
      className={`z-10 flex shrink-0 flex-col justify-between self-center bg-gray-100 px-2.5 pt-4 pb-5 shadow-xs md:p-6 lg:self-stretch lg:p-7 xl:p-8 2xl:self-center ${
        uiType === 'collapse'
