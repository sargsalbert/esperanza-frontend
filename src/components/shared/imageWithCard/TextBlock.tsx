  ...
  return (
    <div
      className={`z-10 flex shrink-0 flex-col ${
        uiType === 'collapse'
          ? 'mx-7.5 w-full after:absolute after:bottom-0 after:left-1/2 after:block after:h-[2px] after:w-[calc(100%-64px)] after:translate-x-[-50%] after:bg-gray-200 after:content-[""] lg:w-[50%] xl:w-[45%] 2xl:w-[40%]'
