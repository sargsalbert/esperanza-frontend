    ...
    <>
      <span
        className={`absolute h-0.5 rounded-xl bg-gray-800 transition-all duration-300 ease-in-out ${
          isOpen
            ...
            : 'w-[22px] -translate-y-1.5 rotate-0 lg:w-[30px] lg:-translate-y-2.5 2xl:w-[36px] 2xl:-translate-y-2.5'
        }`}
      />
      <span
        className={`absolute h-0.5 rounded-xl bg-gray-800 transition-all duration-300 ease-in-out ${
      ...
      <span
        className={`absolute h-0.5 rounded-xl bg-gray-800 transition-all duration-300 ease-in-out ${
          isOpen
            ? 'w-0 opacity-0'
            : 'w-[10px] translate-y-1.5 lg:w-[12px] lg:translate-y-2.5 2xl:w-[16px] 2xl:translate-y-2.5'
        }`}
      />
    </>
  );
